...
class ProductController {
  async create(req, res) {
    try {
      ...
      const product_category = await CategoryProductDAO.create(
        product.id,
        idsCategories,
      );
      ...
      return res
        .status(400)
        .json({
          message: "There was an error while creating the product: " + error,
        });
    }
  }
  ...
  async getAll(req, res) {
    try {
      ...
      return res
        .status(400)
        .json({
          message: "There was an error while getting the products: " + error,
        });
    }
  }
  ...
  async getByPk(req, res) {
    try {
      ...
      return res
        .status(400)
        .json({
          message: "There was an error while getting the product: " + error,
        });
    }
  }
  ...
  async update(req, res) {
    try {
      ...
      const categories_products =
        await CategoryProductDAO.getCategoryPerProduct(id);
      ...
      return res
        .status(400)
        .json({
          message: "There was an error while updating the product: " + error,
        });
    }
  }
  ...
  async delete(req, res) {
    try {
      ...
      return res
        .status(400)
        .json({
          message: "There was an error while deleting the product: " + error,
        });
    }
  }
}
